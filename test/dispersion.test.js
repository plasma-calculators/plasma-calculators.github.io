...
const { evaluateRefractiveIndex, computeDispersionProperties } = require('../assets/js/dispersion-engine.js');
...
// Target n = 1.43051, GVD = 19.14 fs^2/mm
...
assertCloseTo('CaF2 GVD @ 800nm', caf2_props.gvd, 19.14, 2.0);
